...
const endIdx = content.indexOf(oldMapEnd, startIdx);

if (endIdx === -1) {
    console.log("Could not find oldMapEnd");
    process.exit(1);
}

const finalEndIdx = endIdx + oldMapEnd.length;
...
console.log("Chat item and swipe patched");
