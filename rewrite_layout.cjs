...
if (content.includes(targetStart) && content.includes(targetEnd)) {
  ...
  const newLayout = `  return (
    ...
    >
      ...
      {/* Main Workspace Frame */}
      <div className="flex-1 flex overflow-hidden relative bg-white dark:bg-zinc-950 md:rounded-l-[40px] md:border-l border-neutral-200/60 dark:border-zinc-800/60 shadow-[-10px_0_30px_-15px_rgba(0,0,0,0.05)]">`;
